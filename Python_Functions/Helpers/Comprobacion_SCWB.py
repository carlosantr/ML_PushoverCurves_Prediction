# -*- coding: utf-8 -*-
"""
Created on Thu Nov 21 22:18:59 2024
...
def comprobacion_norma(variables):#Esta función se encarga de definir si la combinación de parámetros del edificio creado, cumple o no con el criterio de columna fuerte - viga débil
    ...
    w=variables["W"]
    Lx=variables["Lx"]
    Cuantia_Vig=variables["Cuantia_V_Sup"]
    ...
    n_barras_V,A_barras_V,nLineasAcero_V,num_barra_V=DimRefuerzo(B_col,As_C,'Viga')#Número de barras y áreas de columnas
